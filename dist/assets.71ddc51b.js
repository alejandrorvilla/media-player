...
function () {
  ...
  AutoPause.prototype.run = function (player) {
    this.player = player;
    var observer = new IntersectionObserver(this.handlerIntersection.bind(this), {
  ...
  AutoPause.prototype.pause = function (isVisible) {
...
},{}],"assets/LoremIpsum.js":[function(require,module,exports) {
"use strict";
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                loremIpsum = _context.sent;
                this.element.innerHTML = "".concat(loremIpsum, " ").concat(loremIpsum, " ").concat(loremIpsum, " ").concat(loremIpsum, " ").concat(loremIpsum, " ").concat(loremIpsum, " ").concat(loremIpsum, " ").concat(loremIpsum, " ").concat(loremIpsum, " ").concat(loremIpsum);
...
},{}],"assets/singleton.ts":[function(require,module,exports) {
"use strict";
...
var LoremIpsum_js_1 = __importDefault(require("./LoremIpsum.js"));
...
var btnCancel = document.querySelector("#cancelLoad");
var loremIpsum = new LoremIpsum_js_1.default(document.querySelector("#lorempIpsum"));
loremIpsum.render();
...
console.log("Instancia a === Instancia b? ".concat(a === b));
console.log("----------------------------------------");
},{"./MediaPlayer":"assets/MediaPlayer.ts","./plugins/AutoPause":"assets/plugins/AutoPause.ts","./plugins/AutoPlay":"assets/plugins/AutoPlay.ts","./LoremIpsum.js":"assets/LoremIpsum.js","./singleton":"assets/singleton.ts"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
